<ul class="nav" >
	...
	<li><a class="<?php echo isActive($pageName,"home")?>" href="<?php echo  base_url()?>">Home</a></li>

	<li><a class="<?php echo isActive($pageName,"about")?>" href="<?php echo  site_url()?>/students">Students</a></li>
